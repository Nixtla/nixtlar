#' Distributed version of 'nixtla_client_detect_anomalies'
...
#' }
#'
.nixtla_client_detect_anomalies_distributed <- function(df, freq=NULL, id_col=NULL, time_col="ds", target_col="y", level=c(99), clean_ex_first=TRUE, model="timegpt-1", num_partitions=NULL){
