#' Distributed version of 'nixtla_client_historic'
...
#' }
#'
.nixtla_client_historic_distributed <- function(df, freq=NULL, id_col=NULL, time_col="ds", target_col="y", level=NULL, quantiles=NULL, finetune_steps=0, finetune_loss="default", clean_ex_first=TRUE, model="timegpt-1", num_partitions=NULL){
