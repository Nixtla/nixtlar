...
This is a copy of the master branch. 
The goal of this PR is just to verify that the problem with the feat/parallel-processing branch is with the mock files. 
...
Currently, the development version contains some features not yet available in CRAN. To learn more, please read the release notes [here](https://github.com/Nixtla/nixtlar/releases/tag/v0.5.3). 
