...
This vignette assumes you have already set up your API key. If you haven't done this, please read the [Get Started](https://nixtla.github.io/nixtlar/articles/anomaly-detection.html) vignette first. 
...
For any of these functions, simply set the `quantiles` argument to the desired values. Keep in mind that quantiles should all be numbers between 0 and 1. 
